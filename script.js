...
function currentPosition() {
  ...
  function success(position) {
      ...
      img.src = "https://maps.googleapis.com/maps/api/staticmap?markers=size:large%7Ccolor:red%7C" + lat + "," + lon + "&zoom=13&sensor=true&size=1000x300&key=AIzaSyDcIIBUmIPNtDJCykYLxztleOnUpXEJ6sY";
      showMap.append(img);
  }
  function error() {
